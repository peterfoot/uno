...
internal partial class ContentManager
{
	...
	private void SetContent(UIElement? newContent)
	{
		...
		if (_isCoreWindowContent)
		{
			...
			if (_rootVisual is null || _rootBorder is null)
			{
				...
				_rootBorder = new();
				visualTree.SetPublicRootVisual(_rootBorder, rootScrollViewer: null, rootContentPresenter: null);
